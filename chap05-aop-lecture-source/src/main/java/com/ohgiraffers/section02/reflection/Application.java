...
import com.ohgiraffers.section01.aop.MemberDAO;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        // Object 클래스의 getClass() 메소드를 이용하면 class 타입으로 리턴 받아 이용 가능하다.
        Class class2 = new Account().getClass();
        System.out.println("class2 = " + class2);

        try {
            // Class.forName() 메소드를 이용해 런타임 시 로딩을 하고 그 클래스 메타 정보를
            // Class 타입으로 받을 수 있다.
